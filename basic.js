function snake () {
var width = 10, height = 10, length = 4, current = 1, dx = 1, dy = 0, x = 0, y = 0, hasFood = false, newEl = null;
document.body.onkeydown = function(e){
    code = e.which || e.keyCode;
	dx = (code - 38) % 2, dy = (code - 39) % 2;
	};
...
var timer = setInterval(function () {
    ...
    document.querySelector('#current_score').textContent = 'Current length: ' + length;
}, 500);
};